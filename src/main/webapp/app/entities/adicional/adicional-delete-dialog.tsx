...
export const AdicionalDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dispositivosApp.adicional.delete.question">
        <Translate contentKey="dispositivosApp.adicional.delete.question" interpolate={{ id: adicionalEntity.id }}>
