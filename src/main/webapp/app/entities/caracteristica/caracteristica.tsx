  ...
  return (
    <div>
      <h2 id="caracteristica-heading" data-cy="CaracteristicaHeading">
        <Translate contentKey="dispositivosApp.caracteristica.home.title">Caracteristicas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dispositivosApp.caracteristica.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/caracteristica/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="dispositivosApp.caracteristica.home.createLabel">Create new Caracteristica</Translate>
          </Link>
        </div>
      </h2>
        ...
        {caracteristicaList && caracteristicaList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dispositivosApp.caracteristica.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nombre')}>
                  <Translate contentKey="dispositivosApp.caracteristica.nombre">Nombre</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nombre')} />
                </th>
                <th className="hand" onClick={sort('descripcion')}>
                  <Translate contentKey="dispositivosApp.caracteristica.descripcion">Descripcion</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('descripcion')} />
                </th>
                <th>
                  <Translate contentKey="dispositivosApp.caracteristica.dispositivo">Dispositivo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dispositivosApp.caracteristica.home.notFound">No Caracteristicas found</Translate>
            </div>
          )
        )}
      </div>
