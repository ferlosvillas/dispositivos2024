...
export const DispositivoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dispositivosApp.dispositivo.delete.question">
        <Translate contentKey="dispositivosApp.dispositivo.delete.question" interpolate={{ id: dispositivoEntity.id }}>
